...
const AddTodos = ({mutate}:getTodoProps) => {
  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-2 bg-gray-300 rounded-md bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-50 border border-gray-100 p-2">
