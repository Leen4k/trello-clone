  ...
  return (
    <div className="w-screen z-[1000] flex justify-between bg-[#1D2125] text-[#9FADBC] py-2 px-4 fixed">
      ...
      <div className="flex gap-4">
        ...
        {/* {<Sort />}
        {<button className="m-auto inline-flex items-center gap-2 justify-center rounded-md border border-transparent bg-[#22272B] px-4 py-2 text-sm font-medium text-[#B5C2CF] hover:bg-[#101204] focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2"><span className="rounded-full bg-[#000] w-8 h-8 flex items-center justify-center">{name?.toUpperCase()}</span><span>{session?.data?.user?.email}</span></button>}
        ...
        {session.status === "authenticated" && <button className="m-auto inline-flex items-center gap-2 justify-center rounded-md border border-transparent bg-[#22272B] px-4 py-2 text-sm font-medium text-[#B5C2CF] hover:bg-[#101204] focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2"><span className="rounded-full bg-[#000] w-8 h-8 flex items-center justify-center m-auto">{name?.toUpperCase()}</span><span className="hidden md:block">{session?.data?.user?.email}</span></button>}
